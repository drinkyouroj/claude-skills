...
Load `references/voice-rules.md` for voice and rhetorical principles (including "Paragraph Rhythm and Grounding Cadence" — the shared source of truth for accessibility used by `tcn-draft` and `tcn-readability`).
